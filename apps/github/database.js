...
var fields = [
    ...
    {name: 'project', _null: false, type: 'int', size: 25},
    {name: 'repository', _null: false, type: 'string', size: 80},
    {name: 'username', _null: false, type: 'string', size: 80},
    {name: 'password', _null: false, type: 'string', size: 80}
];
